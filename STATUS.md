...
- **Ⅷ (ch300, 게임 최종)** drawVictoryArmageddon — 황금 sphere + 적금 광선 12방향(창조주의 손길) + 중앙 천상의 새우과자(큰 새우과자 + 빛나는 십자가). 헤드라인 KO "천상의 새우과자 — 창조주의 인정!" / EN "Celestial Shrimp Snack!". Sub KO "창조주와 함께 악의 세력을 격퇴 — 천상의 새우과자를 받은 가족" / EN "Family stood beside the Creator — bearers of the Celestial Shrimp Snack".
...
각자 `player.damage × 0.20~0.45`, fireRate 1.0~2.2 (자동 새우과자 사격). 보스 HP는 합류 보너스 분(~10-20%) 가산되어 순기여만큼 보상.
